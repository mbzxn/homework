...
all_types = os.listdir('data/TCGA/processed_matrix_screening')
...
for cancer_type in all_types:
    print(cancer_type)
    patient_id = pd.read_csv('data/TCGA/processed_matrix_screening/'+cancer_type+'/patient_id.csv',index_col=0)
...
for cancer_type in all_types:
    ...
    patient = pd.read_csv('data/TCGA/processed_matrix_screening'+cancer_type+'/patient_id.csv',index_col=0)
